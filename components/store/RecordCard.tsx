    ...
    <>
      <article className="group relative overflow-hidden"
        ...
        <div className="absolute inset-0 md:transition-opacity md:duration-[250ms] md:group-hover:opacity-0">
          ...
          {/* Mobile-only quick-add — top-right, above cover, no overlap with marquee */}
          {isAvailable && (
            <button
              className="md:hidden absolute top-2 right-2 flex items-center justify-center z-10"
              style={{ width: '36px', height: '36px', backgroundColor: accentColor, color: '#000000' }}
